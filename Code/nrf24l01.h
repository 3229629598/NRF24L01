...
#define DYNPD                                         0x1c  //bitx: Enable dynamic payload length data pipe x. (Requires EN_DPL and ENAA_Px)
#define FEATURE                                       0x1D  //bit0: EN_DYN_ACK  Enables the W_TX_PAYLOAD_NOACK command
